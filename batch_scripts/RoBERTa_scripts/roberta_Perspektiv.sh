...
#BSUB -o batch_out/roberta_Perspektiv.out
#BSUB -e batch_out/roberta_Perspektiv.err

# here follow the commands you want to execute 
python3 run_roberta_finetune.py --target_col "Perspektiv"
