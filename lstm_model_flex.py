...
class lstm_text(pl.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.l1 = nn.Linear(
            in_features=self.hidden_size * 2,  # multiplied by 2 if bidirectional,
            out_features=self.l1_size,
        )

        self.l2 = nn.Linear(in_features=self.l1_size, out_features=self.l2_size)

        self.out_layer = nn.Linear(
            in_features=self.l2_size, out_features=self.output_size
        )
