"""
This script is to continue training BabyBERTa_131022 (NO WARMUP) with the MLM task
"""
...
model = RobertaForMaskedLM.from_pretrained("./models/BabyBERTa_131022").cuda()
...
training_args = TrainingArguments(
    output_dir="./models/BabyBERTa_131022_GW",
